...
module.exports = (function(){
  ...
  var findInjectionPoints = function(src) {
    ...
    while (injTags.length != 0) {
      ...
      if (startTag.open.index < index)
        throw { msg: "tags out of order", idx: startTag.open.index };

      if (endTag.open.index < index)
        throw { msg: "tags out of order", idx: endTag.open.index };
    
      if (startTag.open.index > endTag.open.index)
        throw { msg: "tags out of order", idx: endTag.open.index };
